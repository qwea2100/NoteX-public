...
本專案採用[雙軌商業模式](../overview/business-model.md)，同時提供免費內容（用於導流）與付費內容（主要營收來源）。由於點數與新台幣並非 1:1 兌換的折抵關係，若讓免費與付費商品混合在同一張訂單中結帳，會讓「這筆訂單到底扣了多少點數／該付多少錢」變得難以清楚呈現，也增加後續對帳的複雜度。
